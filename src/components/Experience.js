      ...
      <div className="experience-grid">
        ...
        <div className="experience-card">
          ...
          <ul>
            ...
            <li>Created ELT pipelines in Python Apache Airflow to ingest raw files from AWS S3 into Snowflake staging areas, then transform 
and load into production schemas.
</li>
